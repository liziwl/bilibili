...
for i in range(17501, 17550):
    url = 'http://bilibili.com/video/av' + str(i)
    urls.append(url)

# result = []
he = ("id","av","cid","title","tminfo","time","click","danmu","coins","favourites","duration","honor_click","honor_coins","honor_favourites")
            ...
            if cid_html_1 or cid_html_2:
                ...
                for video_each in video_selector:
                    ...
                    if jsDict['code'] == 0:
                        ...
                        try:
                            conn = MySQLdb.connect(host='localhost', user='root', passwd='267289', port=3306,
                                                   charset='utf8')
                            cur = conn.cursor()
                            conn.select_db('sys')

                            # dat = 'INSERT INTO video VALUES ({},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{})'.format(
                            #     dat='INSERT INTO video VALUES ({},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{})'.format(
                            #         [str(av), str(av), cid, title, tminfo, time, click, danmu, coins, favourites,
                            #          duration,
                            #          mid, name, article, fans, tag1, tag2, tag3, str(common), honor_click, honor_coins,
                            #          honor_favourites])

                            dat="INSERT INTO video VALUES ({},{},{},\"{}\",\"{}\",\"{}\",{},{},{},{},\"{}\",{},{},{},{},\"{}\",\"{}\",\"{}\",{},{},{},{})".format(str(av), str(av), cid, title, tminfo, time, click, danmu, coins, favourites, duration,mid, name, article, fans, tag1, tag2, tag3, str(common), honor_click, honor_coins,honor_favourites)
                            # dat = (str(av), str(av), cid, title, tminfo, time, click, danmu, coins, favourites, duration,mid, name, article, fans, tag1, tag2, tag3, str(common), honor_click, honor_coins,honor_favourites)
                            print dat
                            # result.append(dat)
                            f_csv.writerow(dat)
                            cur.execute(dat)
